...
const images = [
  ...
  "https://picsum.photos/id/1005/200/150",
  "https://picsum.photos/id/1002/200/250",
  "https://picsum.photos/id/1003/200/120",
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-center justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-4xl font-bold mb-4">
            Meet Our <span className="text-green-600">Top-Rated</span> Mentors
          </h2>
          <p className="text-gray-700 mb-8">
            Discover the best mentors in your field. Our top-rated experts are
            ready to guide you.
          </p>
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-2">
                Connect with highly-rated mentors who can elevate your skills
                and knowledge.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 flex-1">
          {images.map((src, i) => (
            <img
              ...
              src={src}
              alt={`mentor-${i}`}
              className="rounded-lg object-cover size-46"
            />
          ))}
        </div>
      </div>
